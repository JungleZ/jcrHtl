if(isContainFindAServiceStore && $('#mapType').val() == 'fixed') {
    ...
    function longservice(){
		...
		ajaxRequireByServiceCenter.getServiceAddress(serviceStoreOptions.latitude,serviceStoreOptions.longitude,"paris",300)
		getRoadMap();
	}
	 ...
	 var GoogleMaps = (function () {
	    ...
	    function AnchorClick(index) {
	        ...
	        setTimeout(function () {
	            ...
	            // Add analytic when user click on any of the result (For fixed type map)
                analyticsSubmit("support > SERVICE CENTER","Click", Stores[index].networkName, EVENT_CLICK_FIND_SERVICE_CENTER);
	        }, 0);
