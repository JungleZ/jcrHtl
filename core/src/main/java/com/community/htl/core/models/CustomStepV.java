...
@Properties({
		...
		@Property(name = "process.label", value = "My First Workflow Step ") })
public class CustomStepV implements WorkflowProcess {
	...
	public void execute(WorkItem item, WorkflowSession wfsession,
		...
		try {
			log.info("**** Here process 2 in execute method"); // ensure that the execute
														// method is invoked
